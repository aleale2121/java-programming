...
public class Story {
    ...
    public static void main(String[] args) {
        ...
        String name = scanner.nextLine(); // Read the character's name
        System.out.println("What is their job?");
        String profession = scanner.nextLine(); // Read the character's job
        
        // Print the story using the provided inputs
